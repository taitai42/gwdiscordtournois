...
const translations = {
  fr: {
    ...
    cmdSetupAtaDesc: 'Activer ou désactiver l’envoi automatique du tournoi AT A',
    cmdSetupAtbDesc: 'Activer ou désactiver l’envoi automatique du tournoi AT B',
    cmdSetupAtcDesc: 'Activer ou désactiver l’envoi automatique du tournoi AT C',
    cmdSetupMatDesc: 'Activer ou désactiver l’envoi automatique du tournoi mensuel mAT (posté le 1er du mois)',
  ...
  en: {
    ...
    cmdSetupAtaDesc: 'Enable or disable automatic posting for the AT A tournament',
    cmdSetupAtbDesc: 'Enable or disable automatic posting for the AT B tournament',
    cmdSetupAtcDesc: 'Enable or disable automatic posting for the AT C tournament',
    cmdSetupMatDesc: 'Enable or disable automatic posting for the monthly mAT tournament (posted on day 1 of the month)',
